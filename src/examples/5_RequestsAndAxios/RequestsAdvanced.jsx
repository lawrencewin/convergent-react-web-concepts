...
export default function RequestsWithUploads() {
    ...
    return (
        <div>
            <p>
                {files
                    ? `You've selected ${files.length} files with a total size of ${size} bytes.`
            ...
            {typeof responseData === "object" && (
                <div>
                    <p>
                        You've uploaded{" "}
                        <strong>{responseData.totalUploads} files</strong>, or{" "}
                        <strong>{responseData.totalSize} bytes</strong>, to the
                        server at <strong>{ENDPOINT}</strong>. Here's some
                        information about what you've sent.
                    </p>
                    <ol>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            Size: <strong>{f.size} B</strong>
                                        </li>
                                        <li>
                                            First 10 bytes:{" "}
                                            <code>{f.firstTenBytes}</code>
                                        </li>
                                    </ul>
                                </li>
                            )
